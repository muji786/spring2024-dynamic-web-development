...
Please see ITP's statement on [Pass/Fail](https://itp.nyu.edu/help/) which states that a "Pass" is equivalent to an "A" or a "B" while anything less would be considered a "Fail".
